          ...
          <div className="row text-center ">
            <div className="col-md-12">
              <div className="upComing">
                <h4 className='text-light'>Home <span className='mx-3'><i class="bi bi-book"></i></span> Event</h4>
                <h2 className='text-center text-light pb-3 mb-2'>Upcoming Events</h2>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container">
        <div className="row py-5">
          <div className="Festival  col-md-12 text-center">
            <h6 className='text-danger text-uppercase'>Event</h6>
        ...
        <div className="row d-flex gap-3 py-2">
          ...
          <div className="reading col-md-6 d-flex gap-3 p-0 mb-3">
            ...
            <div className="dolor">
              ...
              <li><i class="fa-regular fa-clock me-2 "></i>May 21, 2024</li>
            </div>
          </div>
        </div>
        ...
        <div className="row d-flex gap-3 py-2">
          <div className="reading col-md-6 d-flex gap-3 p-0 mb-3">
            ...
            <div className="dolor">
              ...
              <p>Lorem ipsum dolor sit amet <br /> consectetur adipiscing elit dolor</p>
              <li><i class="fa-solid fa-location-dot me-3"></i>JCC, Jakarta</li>
              <li><i class="fa-regular fa-clock me-2 "></i>May 28, 2024</li>
            </div>
          </div>
          <div className="reading col-md-6 d-flex gap-3 p-0 mb-3">
            ...
            <div className="dolor">
              ...
              <li><i class="fa-regular fa-clock me-2 "></i>June 4, 2024</li>
            </div>
          </div>
        </div>
            ...
            <div class="accordion accordion-flush" id="accordionFlushExample">
              <div class="accordion-item">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">Imperdiet velit taciti at viverra rhoncus facilisis diam. Hac gravida eget natoque rutrum sapien dis pretium libero. Ut est lectus mus nisi fermentum montes dapibus eu. Auctor fusce cubilia justo a lacinia. This is the first item's accordion body.</div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">Imperdiet velit taciti at viverra rhoncus facilisis diam. Hac gravida eget natoque rutrum sapien dis pretium libero. Ut est lectus mus nisi fermentum montes dapibus eu. Auctor fusce cubilia justo a lacinia. This is the second item's accordion body. Let's imagine this being filled with some actual content.</div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">Imperdiet velit taciti at viverra rhoncus facilisis diam. Hac gravida eget natoque rutrum sapien dis pretium libero. Ut est lectus mus nisi fermentum montes dapibus eu. Auctor fusce cubilia justo a lacinia. This is the third item's accordion body. Nothing more exciting happening here in terms of content, but just filling up the space to make it look, at least at first glance, a bit more representative of how this would look in a real-world application.</div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">Imperdiet velit taciti at viverra rhoncus facilisis diam. Hac gravida eget natoque rutrum sapien dis pretium libero. Ut est lectus mus nisi fermentum montes dapibus eu. Auctor fusce cubilia justo a lacinia. This is the fourth item's accordion body. Nothing more exciting happening here in terms of content, but just filling up the space to make it look, at least at first glance, a bit more representative of how this would look in a real-world application.</div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">Imperdiet velit taciti at viverra rhoncus facilisis diam. Hac gravida eget natoque rutrum sapien dis pretium libero. Ut est lectus mus nisi fermentum montes dapibus eu. Auctor fusce cubilia justo a lacinia. This is the fifth item's accordion body. Nothing more exciting happening here in terms of content, but just filling up the space to make it look, at least at first glance, a bit more representative of how this would look in a real-world application.</div>
                </div>
              </div>
            </div>
          </div>
