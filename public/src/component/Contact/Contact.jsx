...
function Contact() {
  return (
    <>
          ...
          <div className="row text-center ">
            <div className="col-md-12">
              <div className="upComing">
                <h4 className='text-light text-center'><span>Home <span className='mx-3 '><i class="bi bi-book fs-5 "></i></span> Contact</span></h4>
      ...
      {/* third section */}
      <div className="container my-5" style={{ background: "#f8f8f8",borderRadius: '20px' }}>
        <div className="row">
          <div className="col-md-6 p-0">
            <iframe 
              ...
              width={600}
              height={500} style={{ border: 0,borderRadius: '20px' }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
          </div>
          <div className="maping col-md-6">
            ...
            <div className="row mb-3">
              <div className="col-md-6">
                <input type="text" className="form-control rounded-pill border-0" placeholder="Name" />
              </div>
              <div className="col-md-6">
                <input type="number" className="form-control rounded-pill border-0" placeholder="Phone" />
              </div>
            </div>
            <div className="row mb-3">
              <div className="col-md-12">
                <input type="email" className="form-control rounded-pill border-0" placeholder="Email" />
              </div>
            </div>
            <div className="row mb-3">
              <div className="col-md-12">
                <input type="text" className="form-control rounded-pill border-0" placeholder="Subject" />
              </div>
            </div>
            <div className="row mb-3">
              <div className="col-md-12">
                <textarea name="Message" className="form-control rounded border-0" rows="4" placeholder="Message"></textarea>
              </div>
            </div>
            <button type="submit" className="form-control rounded-pill border-0 text-light" id='submit'><i class="fa-solid fa-envelope-open-text me-2"></i> Send My Message</button>
          </div>
        </div>
